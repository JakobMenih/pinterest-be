...
let UsersController = class UsersController {
    ...
    getProfile(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.usersService.getUserById(req.user.userId);
        });
    }
    // List all users (consider restricting this in production)
    getAllUsers() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.usersService.getAllUsers();
        });
    }
    ...
    updateUser(id, updateData, req) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.user.userId !== id) {
                throw new common_1.UnauthorizedException('You can only update your own account');
            }
            return yield this.usersService.updateUser(id, updateData);
        });
    }
